...
/// </summary>
[OcsfObject("access_analysis_result")]
public class AccessAnalysisResult : OcsfObject
{
    /// <summary>
    ...
    public List<User>? Accessors { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("additional_restrictions")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Optional)]
    public List<AdditionalRestriction>? AdditionalRestrictions { get; set; }
