...
public class Token : OcsfObject
{
    ...
    /// </summary>
    public void SetType(TokenTypeId typeId, string? type = null)
    {
        TypeId = typeId;
...
/// <summary>Schema caption lookup for <see cref="TokenTypeId"/>.</summary>
public static class TokenTypeIdExtensions
{
    /// <summary>The schema caption of the value, or null for values not defined by the schema.</summary>
    public static string? Caption(this TokenTypeId value) => value switch
    {
        (TokenTypeId)0 => "Unknown",
        (TokenTypeId)1 => "Ticket Granting Ticket",
        (TokenTypeId)2 => "Service Ticket",
        (TokenTypeId)3 => "Identity Token",
        (TokenTypeId)4 => "Refresh Token",
        (TokenTypeId)5 => "SAML Assertion",
        (TokenTypeId)6 => "Client Token",
        (TokenTypeId)7 => "API Token",
        (TokenTypeId)99 => "Other",
        _ => null,
    };
}
