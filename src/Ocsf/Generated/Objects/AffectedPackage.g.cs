...
/// </summary>
[OcsfObject("affected_package")]
public class AffectedPackage : OcsfObject
{
    /// <summary>
    ...
    /// </summary>
    [JsonPropertyName("fixed_in_version")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Optional)]
    ...
    /// </summary>
    public void SetType(AffectedPackageTypeId typeId, string? type = null)
    {
        TypeId = typeId;
...
/// </summary>
public enum AffectedPackageTypeId
{
    /// <summary>
    /// The type is unknown.
    /// </summary>
...
/// <summary>Schema caption lookup for <see cref="AffectedPackageTypeId"/>.</summary>
public static class AffectedPackageTypeIdExtensions
{
    /// <summary>The schema caption of the value, or null for values not defined by the schema.</summary>
    public static string? Caption(this AffectedPackageTypeId value) => value switch
    {
        (AffectedPackageTypeId)0 => "Unknown",
        (AffectedPackageTypeId)1 => "Application",
        (AffectedPackageTypeId)2 => "Operating System",
        (AffectedPackageTypeId)99 => "Other",
        _ => null,
    };
}
