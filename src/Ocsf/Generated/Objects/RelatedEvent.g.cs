...
public class RelatedEvent : OcsfObject
{
    ...
    /// </summary>
    public void SetSeverity(RelatedEventSeverityId severityId, string? severity = null)
    {
...
/// <summary>Schema caption lookup for <see cref="RelatedEventSeverityId"/>.</summary>
public static class RelatedEventSeverityIdExtensions
{
    /// <summary>The schema caption of the value, or null for values not defined by the schema.</summary>
    public static string? Caption(this RelatedEventSeverityId value) => value switch
    {
        (RelatedEventSeverityId)0 => "Unknown",
        (RelatedEventSeverityId)1 => "Informational",
        (RelatedEventSeverityId)2 => "Low",
        (RelatedEventSeverityId)3 => "Medium",
        (RelatedEventSeverityId)4 => "High",
        (RelatedEventSeverityId)5 => "Critical",
        (RelatedEventSeverityId)6 => "Fatal",
        (RelatedEventSeverityId)99 => "Other",
        _ => null,
    };
}
