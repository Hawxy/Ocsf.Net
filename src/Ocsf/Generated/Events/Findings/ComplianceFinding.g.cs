...
/// <summary>
/// Compliance Finding.
/// Compliance Finding events describe results of evaluations performed against resources, to check compliance with various Industry Frameworks or Security Standards such as <c>NIST SP 800-53, CIS AWS Foundations Benchmark v1.4.0, ISO/IEC 27001</c> etc. Note: if the event producer is a security control, the <c>security_control</c> profile should be applied and its <c>attacks</c> information, if present, should be duplicated into the <c>finding_info</c> object.
...
/// </summary>
[OcsfEventClass(2003, 2, "compliance_finding")]
public class ComplianceFinding : OcsfEvent
{
    /// <summary>The <c>class_uid</c> of the <c>compliance_finding</c> event class.</summary>
    public const int EventClassUid = 2003;

    /// <summary>The <c>category_uid</c> of the <c>compliance_finding</c> event class.</summary>
    ...
    public ComplianceFindingActionId? ActionId { get; set; }
    ...
    public ComplianceFindingActivityId? ActivityId { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Recommended)]
    public ComplianceFindingConfidenceId? ConfidenceId { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Recommended)]
    public ComplianceFindingDispositionId? DispositionId { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Recommended)]
    public ComplianceFindingImpactId? ImpactId { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Recommended)]
    public ComplianceFindingPriorityId? PriorityId { get; set; }
    ...
    /// Requirement: recommended.
    /// </summary>
    [Obsolete("Use the resources attribute instead. Deprecated since 1.3.0.")]
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Optional)]
    public ComplianceFindingRiskLevelId? RiskLevelId { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Required)]
    public ComplianceFindingSeverityId? SeverityId { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Recommended)]
    public ComplianceFindingStatusId? StatusId { get; set; }
...
/// </summary>
public enum ComplianceFindingActionId
{
    /// <summary>
...
/// </summary>
public enum ComplianceFindingActivityId
{
    /// <summary>
...
/// </summary>
public enum ComplianceFindingConfidenceId
{
    /// <summary>
...
/// </summary>
public enum ComplianceFindingDispositionId
{
    /// <summary>
...
/// </summary>
public enum ComplianceFindingImpactId
{
    /// <summary>
...
/// </summary>
public enum ComplianceFindingPriorityId
{
    /// <summary>
...
/// </summary>
public enum ComplianceFindingRiskLevelId
{
    Info = 0,
    Low = 1,
    Medium = 2,
...
/// </summary>
public enum ComplianceFindingSeverityId
{
    /// <summary>
...
/// </summary>
public enum ComplianceFindingStatusId
{
    /// <summary>
...
/// </summary>
public enum ComplianceFindingVerdictId
{
    /// <summary>
    /// The type is unknown.
    /// </summary>
