...
[OcsfEventClass(5022, 5, "startup_item_query")]
public class StartupItemQuery : OcsfEvent
{
    /// <summary>The <c>class_uid</c> of the <c>startup_item_query</c> event class.</summary>
    public const int EventClassUid = 5022;

    /// <summary>The <c>category_uid</c> of the <c>startup_item_query</c> event class.</summary>
    public const int EventCategoryUid = 5;

    /// <summary>Initializes the classification attributes to this class's identity.</summary>
    public StartupItemQuery()
    {
        ClassUid = EventClassUid;
        CategoryUid = EventCategoryUid;
        TypeUid = EventClassUid * 100L;
        ClassName = "Startup Item Query";
    ...
    public StartupItemQueryActionId? ActionId { get; set; }
    ...
    public StartupItemQueryActivityId? ActivityId { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Recommended)]
    public StartupItemQueryConfidenceId? ConfidenceId { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Recommended)]
    public StartupItemQueryDispositionId? DispositionId { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Required)]
    public StartupItemQueryQueryResultId? QueryResultId { get; set; }
    ...
    public StartupItemQueryRiskLevelId? RiskLevelId { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Required)]
    public StartupItemQuerySeverityId? SeverityId { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Required)]
    public Objects.StartupItem? StartupItem { get; set; }
...
/// </summary>
public enum StartupItemQueryActionId
{
    /// <summary>
...
/// </summary>
public enum StartupItemQueryActivityId
{
    /// <summary>
...
/// </summary>
public enum StartupItemQueryConfidenceId
{
    /// <summary>
...
/// </summary>
public enum StartupItemQueryDispositionId
{
    /// <summary>
...
/// </summary>
public enum StartupItemQueryQueryResultId
{
    /// <summary>
...
/// </summary>
public enum StartupItemQueryRiskLevelId
{
    Info = 0,
    Low = 1,
    Medium = 2,
...
/// </summary>
public enum StartupItemQuerySeverityId
{
    /// <summary>
...
/// </summary>
public enum StartupItemQueryStatusId
{
    /// <summary>
