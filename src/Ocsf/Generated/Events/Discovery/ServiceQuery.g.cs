...
[OcsfEventClass(5016, 5, "service_query")]
public class ServiceQuery : OcsfEvent
{
    /// <summary>The <c>class_uid</c> of the <c>service_query</c> event class.</summary>
    public const int EventClassUid = 5016;

    /// <summary>The <c>category_uid</c> of the <c>service_query</c> event class.</summary>
    ...
    [OcsfSibling("Action")]
    public ServiceQueryActionId? ActionId { get; set; }
    ...
    public ServiceQueryActivityId? ActivityId { get; set; }
    ...
    public ServiceQueryConfidenceId? ConfidenceId { get; set; }
    ...
    public ServiceQueryDispositionId? DispositionId { get; set; }
    ...
    public ServiceQueryQueryResultId? QueryResultId { get; set; }
    ...
    public ServiceQueryRiskLevelId? RiskLevelId { get; set; }
    ...
    public ServiceQuerySeverityId? SeverityId { get; set; }
...
/// </summary>
public enum ServiceQueryActionId
{
    /// <summary>
...
/// </summary>
public enum ServiceQueryActivityId
{
    /// <summary>
...
/// </summary>
public enum ServiceQueryConfidenceId
{
    /// <summary>
...
/// </summary>
public enum ServiceQueryDispositionId
{
    /// <summary>
...
/// </summary>
public enum ServiceQueryQueryResultId
{
    /// <summary>
...
/// </summary>
public enum ServiceQueryRiskLevelId
{
    Info = 0,
    Low = 1,
    Medium = 2,
...
/// </summary>
public enum ServiceQuerySeverityId
{
    /// <summary>
...
/// </summary>
public enum ServiceQueryStatusId
{
    /// <summary>
