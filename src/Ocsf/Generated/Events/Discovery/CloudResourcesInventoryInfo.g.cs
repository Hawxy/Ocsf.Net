...
public class CloudResourcesInventoryInfo : OcsfEvent
{
    ...
    public const int EventClassUid = 5023;

    /// <summary>The <c>category_uid</c> of the <c>cloud_resources_inventory_info</c> event class.</summary>
    public const int EventCategoryUid = 5;

    /// <summary>Initializes the classification attributes to this class's identity.</summary>
    public CloudResourcesInventoryInfo()
    {
        ClassUid = EventClassUid;
        CategoryUid = EventCategoryUid;
        TypeUid = EventClassUid * 100L;
        ClassName = "Cloud Resources Inventory Info";
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Recommended)]
    public Objects.Idp? Idp { get; set; }

    /// <summary>
    /// The cloud region where the resource is located, e.g., <c>us-isof-south-1</c>, <c>eastus2</c>, <c>us-central1</c>, etc.
    /// Requirement: recommended.
    /// </summary>
...
/// </summary>
public enum CloudResourcesInventoryInfoActionId
{
    /// <summary>
...
/// </summary>
public enum CloudResourcesInventoryInfoActivityId
{
    /// <summary>
...
/// </summary>
public enum CloudResourcesInventoryInfoConfidenceId
{
    /// <summary>
...
/// </summary>
public enum CloudResourcesInventoryInfoDispositionId
{
    /// <summary>
...
/// </summary>
public enum CloudResourcesInventoryInfoRiskLevelId
{
    Info = 0,
    Low = 1,
    Medium = 2,
...
/// </summary>
public enum CloudResourcesInventoryInfoSeverityId
{
    /// <summary>
...
/// </summary>
public enum CloudResourcesInventoryInfoStatusId
{
    /// <summary>
