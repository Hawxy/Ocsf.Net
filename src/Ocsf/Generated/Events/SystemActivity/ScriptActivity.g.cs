...
/// </summary>
[OcsfEventClass(1009, 1, "script_activity")]
public class ScriptActivity : OcsfEvent
{
    /// <summary>The <c>class_uid</c> of the <c>script_activity</c> event class.</summary>
    public const int EventClassUid = 1009;

    /// <summary>The <c>category_uid</c> of the <c>script_activity</c> event class.</summary>
    ...
    public ScriptActivityActionId? ActionId { get; set; }
    ...
    public ScriptActivityActivityId? ActivityId { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Recommended)]
    public ScriptActivityConfidenceId? ConfidenceId { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Recommended)]
    public ScriptActivityDispositionId? DispositionId { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Optional)]
    public ScriptActivityRiskLevelId? RiskLevelId { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Required)]
    public ScriptActivitySeverityId? SeverityId { get; set; }
...
/// </summary>
public enum ScriptActivityActionId
{
    /// <summary>
...
/// </summary>
public enum ScriptActivityActivityId
{
    /// <summary>
...
/// </summary>
public enum ScriptActivityConfidenceId
{
    /// <summary>
...
/// </summary>
public enum ScriptActivityDispositionId
{
    /// <summary>
...
/// </summary>
public enum ScriptActivityRiskLevelId
{
    Info = 0,
    Low = 1,
    Medium = 2,
...
/// </summary>
public enum ScriptActivitySeverityId
{
    /// <summary>
...
/// </summary>
public enum ScriptActivityStatusId
{
    /// <summary>
