...
public class DroneFlightsActivity : OcsfEvent
{
    ...
    /// <summary>
    /// The authentication type as defined by the caption of <c>auth_protocol_id</c>. In the case of 'Other', it is defined by the event source.
    /// </summary>
    ...
    /// <summary>
    /// The networking protocol associated with the Remote ID device or beacon. E.g. <c>BLE</c>, <c>LTE</c>, <c>802.11</c>.
    /// </summary>
    ...
    /// <summary>
    /// Traffic refers to the amount of data transmitted from a Unmanned Aerial System (UAS) or Counter Unmanned Aerial System (UAS) (CUAS) system at a given point of time. Ex: <c>bytes_in</c> and <c>bytes_out</c>.
    /// </summary>
...
/// </summary>
public enum DroneFlightsActivityActionId
{
    /// <summary>
...
/// </summary>
public enum DroneFlightsActivityActivityId
{
    /// <summary>
...
/// </summary>
public enum DroneFlightsActivityAuthProtocolId
{
    /// <summary>
    ...
    None = 1,
    UASIDSignature = 2,
    OperatorIDSignature = 3,
    MessageSetSignature = 4,
    AuthenticationProvidedByNetworkRemoteID = 5,
    SpecificAuthenticationMethod = 6,
    Reserved = 7,
    PrivateUser = 8,
    EAP = 9,
    RADIUS = 10,
    ...
    LDAP = 12,
    /// <summary>
    /// The authentication type is not mapped. See the <c>auth_protocol</c> attribute, which contains a data source specific value.
    /// </summary>
    Other = 99,
}
...
/// </summary>
public enum DroneFlightsActivityConfidenceId
{
    /// <summary>
...
/// </summary>
public enum DroneFlightsActivityDispositionId
{
    /// <summary>
...
/// </summary>
public enum DroneFlightsActivityRiskLevelId
{
    Info = 0,
    Low = 1,
    Medium = 2,
...
/// </summary>
public enum DroneFlightsActivitySeverityId
{
    /// <summary>
...
/// </summary>
public enum DroneFlightsActivityStatusId
{
    /// <summary>
    ...
    Emergency = 4,
    /// <summary>
    /// The Unmanned Aerial System (UAS) is reporting the Remote ID beacon or device is malfunctioning or has failed.
    /// </summary>
    RemoteIDSystemFailure = 5,
    /// <summary>
