...
/// </summary>
[OcsfEventClass(0, 0, "base_event")]
public class BaseEvent : OcsfEvent
{
    /// <summary>The <c>class_uid</c> of the <c>base_event</c> event class.</summary>
    public const int EventClassUid = 0;

    /// <summary>The <c>category_uid</c> of the <c>base_event</c> event class.</summary>
    public const int EventCategoryUid = 0;
    ...
    public BaseEventActionId? ActionId { get; set; }
    ...
    public BaseEventActivityId? ActivityId { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Recommended)]
    public BaseEventConfidenceId? ConfidenceId { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Recommended)]
    public BaseEventDispositionId? DispositionId { get; set; }
    ...
    public BaseEventRiskLevelId? RiskLevelId { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Required)]
    public BaseEventSeverityId? SeverityId { get; set; }
...
/// </summary>
public enum BaseEventActivityId
{
    /// <summary>
...
/// </summary>
public enum BaseEventConfidenceId
{
    /// <summary>
...
/// </summary>
public enum BaseEventDispositionId
{
    /// <summary>
...
/// </summary>
public enum BaseEventRiskLevelId
{
    Info = 0,
    Low = 1,
    Medium = 2,
...
/// </summary>
public enum BaseEventSeverityId
{
    /// <summary>
