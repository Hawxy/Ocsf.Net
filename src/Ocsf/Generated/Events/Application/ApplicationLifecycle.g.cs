...
/// </summary>
[OcsfEventClass(6002, 6, "application_lifecycle")]
[OcsfConstraint(OcsfConstraintKind.AtLeastOne, "App", "Application")]
public class ApplicationLifecycle : OcsfEvent
{
    /// <summary>The <c>class_uid</c> of the <c>application_lifecycle</c> event class.</summary>
    public const int EventClassUid = 6002;

    /// <summary>The <c>category_uid</c> of the <c>application_lifecycle</c> event class.</summary>
    ...
    [OcsfSibling("Action")]
    public ApplicationLifecycleActionId? ActionId { get; set; }
    ...
    public ApplicationLifecycleActivityId? ActivityId { get; set; }
    ...
    /// </summary>
    [Obsolete("Use the application attribute instead. Deprecated since 1.9.0.")]
    [JsonPropertyName("app")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Optional)]
    public Objects.Product? App { get; set; }

    /// <summary>
    /// The application that was affected by the lifecycle event. This also applies to self-updating application systems. Product identity, such as vendor and version, can be conveyed via the nested <c>product</c> attribute.
    ...
    public ApplicationLifecycleConfidenceId? ConfidenceId { get; set; }
    ...
    public ApplicationLifecycleDispositionId? DispositionId { get; set; }
    ...
    public ApplicationLifecycleRiskLevelId? RiskLevelId { get; set; }
    ...
    public ApplicationLifecycleSeverityId? SeverityId { get; set; }
...
/// </summary>
public enum ApplicationLifecycleActionId
{
    /// <summary>
...
/// </summary>
public enum ApplicationLifecycleActivityId
{
    /// <summary>
...
/// </summary>
public enum ApplicationLifecycleConfidenceId
{
    /// <summary>
...
/// </summary>
public enum ApplicationLifecycleDispositionId
{
    /// <summary>
...
/// </summary>
public enum ApplicationLifecycleRiskLevelId
{
    Info = 0,
    Low = 1,
    Medium = 2,
...
/// </summary>
public enum ApplicationLifecycleSeverityId
{
    /// <summary>
...
/// </summary>
public enum ApplicationLifecycleStatusId
{
    /// <summary>
