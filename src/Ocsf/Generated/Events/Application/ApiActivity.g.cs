...
/// </summary>
[OcsfEventClass(6003, 6, "api_activity")]
public class ApiActivity : OcsfEvent
{
    /// <summary>The <c>class_uid</c> of the <c>api_activity</c> event class.</summary>
    public const int EventClassUid = 6003;

    /// <summary>The <c>category_uid</c> of the <c>api_activity</c> event class.</summary>
    ...
    [OcsfSibling("Action")]
    public ApiActivityActionId? ActionId { get; set; }
    ...
    public ApiActivityActivityId? ActivityId { get; set; }
    ...
    public ApiActivityConfidenceId? ConfidenceId { get; set; }
    ...
    public ApiActivityDispositionId? DispositionId { get; set; }
    ...
    public ApiActivityRiskLevelId? RiskLevelId { get; set; }
    ...
    public ApiActivitySeverityId? SeverityId { get; set; }
    ...
    [OcsfRequirement(OcsfRequirement.Recommended)]
    [OcsfSibling("Status")]
    public ApiActivityStatusId? StatusId { get; set; }
...
/// </summary>
public enum ApiActivityActionId
{
    /// <summary>
...
/// </summary>
public enum ApiActivityActivityId
{
    /// <summary>
...
/// </summary>
public enum ApiActivityConfidenceId
{
    /// <summary>
...
/// </summary>
public enum ApiActivityDispositionId
{
    /// <summary>
...
/// </summary>
public enum ApiActivityRiskLevelId
{
    Info = 0,
    Low = 1,
    Medium = 2,
...
/// </summary>
public enum ApiActivitySeverityId
{
    /// <summary>
...
/// </summary>
public enum ApiActivityStatusId
{
    /// <summary>
