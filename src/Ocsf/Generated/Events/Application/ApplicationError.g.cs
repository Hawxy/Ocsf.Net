...
/// <summary>
/// Application Error.
/// Application Error events describe issues with an applications. The error message should be put in the event's <c>message</c> attribute. The <c>metadata.product</c> attribute can be used to capture the originating application information. The <c>host</c> profile can used to include the generating device information. This class is helpful for applications that generate or handle OCSF events and can also be used for errors in upstream products and services.
/// </summary>
[OcsfEventClass(6008, 6, "application_error")]
public class ApplicationError : OcsfEvent
{
    /// <summary>The <c>class_uid</c> of the <c>application_error</c> event class.</summary>
    public const int EventClassUid = 6008;

    /// <summary>The <c>category_uid</c> of the <c>application_error</c> event class.</summary>
    ...
    public ApplicationErrorActionId? ActionId { get; set; }
    ...
    public ApplicationErrorActivityId? ActivityId { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Recommended)]
    public ApplicationErrorConfidenceId? ConfidenceId { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Recommended)]
    public ApplicationErrorDispositionId? DispositionId { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Optional)]
    public ApplicationErrorRiskLevelId? RiskLevelId { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Required)]
    public ApplicationErrorSeverityId? SeverityId { get; set; }
...
/// </summary>
public enum ApplicationErrorActionId
{
    /// <summary>
...
/// </summary>
public enum ApplicationErrorActivityId
{
    /// <summary>
...
/// </summary>
public enum ApplicationErrorConfidenceId
{
    /// <summary>
...
/// </summary>
public enum ApplicationErrorDispositionId
{
    /// <summary>
...
/// </summary>
public enum ApplicationErrorRiskLevelId
{
    Info = 0,
    Low = 1,
    Medium = 2,
...
/// </summary>
public enum ApplicationErrorSeverityId
{
    /// <summary>
...
/// </summary>
public enum ApplicationErrorStatusId
{
    /// <summary>
