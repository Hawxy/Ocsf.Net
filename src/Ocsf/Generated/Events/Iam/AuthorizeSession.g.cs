...
public class AuthorizeSession : OcsfEvent
{
    ...
    public const int EventClassUid = 3003;

    /// <summary>The <c>category_uid</c> of the <c>authorize_session</c> event class.</summary>
    ...
    /// </summary>
    [Obsolete("Use groups instead. Deprecated since 1.9.0.")]
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Recommended)]
    public List<Objects.Group>? Groups { get; set; }
...
/// </summary>
public enum AuthorizeSessionActionId
{
    /// <summary>
...
/// </summary>
public enum AuthorizeSessionActivityId
{
    /// <summary>
    ...
    AssignGroups = 2,
    /// <summary>
    /// Assign special roles to a new logon.
    /// </summary>
    AssignRoles = 3,
    /// <summary>
...
/// </summary>
public enum AuthorizeSessionConfidenceId
{
    /// <summary>
...
/// </summary>
public enum AuthorizeSessionDispositionId
{
    /// <summary>
...
/// </summary>
public enum AuthorizeSessionRiskLevelId
{
    Info = 0,
    Low = 1,
    Medium = 2,
...
/// </summary>
public enum AuthorizeSessionSeverityId
{
    /// <summary>
...
/// </summary>
public enum AuthorizeSessionStatusId
{
    /// <summary>
