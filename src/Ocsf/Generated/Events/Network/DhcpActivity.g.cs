...
/// </summary>
[OcsfEventClass(4004, 4, "dhcp_activity")]
[OcsfConstraint(OcsfConstraintKind.AtLeastOne, "DstEndpoint", "SrcEndpoint")]
public class DhcpActivity : OcsfEvent
{
    /// <summary>The <c>class_uid</c> of the <c>dhcp_activity</c> event class.</summary>
    public const int EventClassUid = 4004;

    /// <summary>The <c>category_uid</c> of the <c>dhcp_activity</c> event class.</summary>
    ...
    [OcsfSibling("Action")]
    public DhcpActivityActionId? ActionId { get; set; }
    ...
    public DhcpActivityActivityId? ActivityId { get; set; }
    ...
    public DhcpActivityConfidenceId? ConfidenceId { get; set; }
    ...
    public DhcpActivityDispositionId? DispositionId { get; set; }
    ...
    /// Requirement: recommended.
    /// </summary>
    [JsonPropertyName("lease_dur")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Recommended)]
    public int? LeaseDur { get; set; }
    ...
    public DhcpActivityObservationPointId? ObservationPointId { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Recommended)]
    public Objects.NetworkInterface? Relay { get; set; }
    ...
    public DhcpActivityRiskLevelId? RiskLevelId { get; set; }
    ...
    public DhcpActivitySeverityId? SeverityId { get; set; }
    ...
    [OcsfRequirement(OcsfRequirement.Recommended)]
    [OcsfSibling("Status")]
    public DhcpActivityStatusId? StatusId { get; set; }
...
/// </summary>
public enum DhcpActivityActionId
{
    /// <summary>
...
/// </summary>
public enum DhcpActivityActivityId
{
    /// <summary>
...
/// </summary>
public enum DhcpActivityConfidenceId
{
    /// <summary>
...
/// </summary>
public enum DhcpActivityDispositionId
{
    /// <summary>
...
/// </summary>
public enum DhcpActivityObservationPointId
{
    /// <summary>
...
/// </summary>
public enum DhcpActivityRiskLevelId
{
    Info = 0,
    Low = 1,
    Medium = 2,
...
/// </summary>
public enum DhcpActivitySeverityId
{
    /// <summary>
...
/// </summary>
public enum DhcpActivityStatusId
{
    /// <summary>
