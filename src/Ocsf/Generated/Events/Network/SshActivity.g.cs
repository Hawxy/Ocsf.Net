...
public class SshActivity : OcsfEvent
{
    ...
    public const int EventClassUid = 4007;

    /// <summary>The <c>category_uid</c> of the <c>ssh_activity</c> event class.</summary>
    ...
    /// Requirement: recommended. Sibling label attribute: <c>auth_type</c>.
    /// </summary>
    ...
    /// Requirement: recommended.
    /// </summary>
    [JsonPropertyName("client_hassh")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Recommended)]
    public Objects.Hassh? ClientHassh { get; set; }
    ...
    /// Requirement: recommended.
    /// </summary>
    [JsonPropertyName("server_hassh")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [OcsfRequirement(OcsfRequirement.Recommended)]
    public Objects.Hassh? ServerHassh { get; set; }
...
/// </summary>
public enum SshActivityActionId
{
    /// <summary>
...
/// </summary>
public enum SshActivityActivityId
{
    /// <summary>
...
/// </summary>
public enum SshActivityAuthTypeId
{
    /// <summary>
    ...
    PublicKey = 6,
    /// <summary>
    /// The authentication type is not mapped. See the <c>auth_type</c> attribute, which contains a data source specific value.
    /// </summary>
    Other = 99,
}
...
/// </summary>
public enum SshActivityConfidenceId
{
    /// <summary>
...
/// </summary>
public enum SshActivityDispositionId
{
    /// <summary>
...
/// </summary>
public enum SshActivityObservationPointId
{
    /// <summary>
...
/// </summary>
public enum SshActivityRiskLevelId
{
    Info = 0,
    Low = 1,
    Medium = 2,
...
/// </summary>
public enum SshActivitySeverityId
{
    /// <summary>
...
/// </summary>
public enum SshActivityStatusId
{
    /// <summary>
